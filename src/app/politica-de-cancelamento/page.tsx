            ...
            <div className="container mx-auto max-w-4xl px-4">
                <div className="rounded-xl border border-border/60 bg-white p-6 md:p-8 shadow-sm">
                    ...
                    <div className="mt-6 space-y-5 text-sm leading-6 text-foreground">
                        <section>
                            <h2 className="font-hero-display font-semibold">1. Cancelamento pelo hóspede</h2>
                            <p>
                        ...
                        <section>
                            <h2 className="font-hero-display font-semibold">2. No-show</h2>
                            <p>
                        ...
                        <section>
                            <h2 className="font-hero-display font-semibold">3. Alteração de datas</h2>
                            <p>
                        ...
                        <section>
                            <h2 className="font-hero-display font-semibold">4. Reembolsos</h2>
                            <p>
                        ...
                        <section>
                            <h2 className="font-hero-display font-semibold">5. Contato</h2>
                            <p>
