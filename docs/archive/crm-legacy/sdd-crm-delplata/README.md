...
> **ARQUIVADO — NÃO USAR COMO ESPECIFICAÇÃO ATUAL.**
>
> Este SDD documenta uma implementação anterior baseada em Evolution API e n8n.
> Foi preservado somente para consulta histórica. A especificação vigente está em
> `docs/product/CRM_AI_PRD.md` e o plano executável em
> `docs/product/CRM_AI_PHASES_TODO.md`.
