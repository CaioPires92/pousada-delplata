# SQL para Produção (Turso) - Cupons

Este script aplica as tabelas/campos de cupons e antifraude sem precisar de seed.

- Arquivo origem: `prisma/migrations/20260211002509_add_coupons_antifraud/migration.sql`
